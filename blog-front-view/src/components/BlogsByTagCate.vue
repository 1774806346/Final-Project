...
// Check whether the id has a value
         // data
        this.titleinfo = "";
        this.blogs = [];
        this.currentPage = 1;
        ...
        screenWidth(val){
// To avoid page stalling due to frequent resize triggers, use a timer
        if(!this.timer){
// If the value of screenWidth monitored changes, it is reassigned to the screenWidth in data
            this.screenWidth = val
            this.timer = true
            let that = this
            setTimeout(function(){
// Prints the value of screenWidth changes
            //the console log (that screenWidth)
                that.timer = false
            },400)
        }
    }
