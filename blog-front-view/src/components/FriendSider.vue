  ...
  <div class="friend">
    <el-card class="box-card">
      <div slot="header" class="d-flex align-items-center">
        ...
        >Exchange friend Link</el-button>
      </div>
      <el-row :gutter="20">
    ...
    <el-dialog title="Exchange friend Lin" :visible.sync="dialogFormVisible" width="30%">
      <el-form ref="friendform" :model="friendform" label-width="70px">
        ...
        <el-form-item label="Link describe">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveEdit">determine</el-button>
      </span>
    </el-dialog>
  </div>
</template>
