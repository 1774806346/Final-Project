  ...
  <div class="about">
    <el-row class="main" type="flex" justify="center">
      <el-col :span="screenWidth > 750 ? 16 : 24">
        <h5 class="title"><i class="el-icon-star-on"></i>about me</h5>
        <el-card shadow="always">
          ...
          <!-- <meting-js
            ...
            type="playlist"
            list-folded="true"
            :id="introduction.musicId"
            theme="#25CCF7"
            v-if="introduction.musicId !== ''"
          ></meting-js> -->
          <div
            class="user-favorites-list"
            v-for="item in introduction.favorites"
            :key="item.title"
          >
          ...
          <div class="talen grid-cont-right">
            ...
            <div class="blog-info">
              ...
              <div>Dynamic number of releases</div>
            </div>
          </div>
