    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-addressbook"></i> Job log
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="logList" border class="table" header-cell-class-name="table-header">
                ...
                <el-table-column prop="browser" label="The browser"></el-table-column>-->
                ...
                <el-table-column label="Operating results" width="80">
                    <template v-slot="scope">
                        <el-tag v-if="scope.row.operateresult=='nomarl'" size="small" effect="dark">successful</el-tag>
