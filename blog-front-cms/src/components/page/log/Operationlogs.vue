    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-addressbook"></i> The operation log
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="logList" border class="table" header-cell-class-name="table-header">
                ...
                <el-table-column prop="operateor" label="user"></el-table-column>
                ...
                <el-table-column prop="description" label="Methods described" show-overflow-tooltip></el-table-column>
                <el-table-column prop="os" label="The operating system" show-overflow-tooltip></el-table-column>
                <el-table-column prop="browser" label="The browser" show-overflow-tooltip></el-table-column>

                    <el-table-column label="Operating time" width="100">
                ...
                <el-table-column label="Operating results" width="80">
                    <template v-slot="scope">
                        <el-tag v-if="scope.row.operateresult=='normal'" size="small" effect="dark">successful</el-tag>
