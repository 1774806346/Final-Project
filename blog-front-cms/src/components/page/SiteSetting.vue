    ...
    <div>
        ...
        <el-row style="margin-top: 20px">
            <el-card>
                ...
                <el-button type="primary" size="mini" icon="el-icon-plus" @click="addBadge">Add the badge</el-button>
            </el-card>
        </el-row>

        <div style="text-align: right;margin-top: 30px">
            <el-button type="primary" icon="el-icon-check" @click="submit">Save</el-button>
        </div>
    </div>
</template>
    ...
    methods: {
        getData() {
            this.$axios
                ...
                .catch(err => {
                    this.$message.error('The request failed');
                });
        },
        addFavorite() {
        ...
        submit() {
            ...
            this.$axios
                ...
                .catch(err => {
                    this.$message.error('No access. Please don\'t try again');
                });
        }
    }
};
