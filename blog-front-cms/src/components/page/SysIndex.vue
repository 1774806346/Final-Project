            ...
            <el-col :span="8">
                ...
                <el-card shadow="hover" style="height:252px;">
                    <div slot="header" class="clearfix">
                        <span>Details of the language</span>
                    </div>Vue
                        ...
                        <el-card shadow="hover" :body-style="{padding: '0px'}">
                            <div class="grid-content grid-con-1">
                                ...
                                <div class="grid-cont-right">
                                    ...
                                    <div>Number of articles published</div>
                                </div>
                            </div>
                        </el-card>
                    </el-col>
                        ...
                        <el-card shadow="hover" :body-style="{padding: '0px'}">
                            <div class="grid-content grid-con-3">
                                ...
                                <div class="grid-cont-right">
                                    ...
                                    <div>The total number of dynamic</div>
                                </div>
                            </div>
                        </el-card>
                    </el-col>
...
export default {
    ...
    computed: {
        role() {
            return this.user.roles === 'admin' ? 'administrator' : 'The average user';
        }
    },
    created() {
